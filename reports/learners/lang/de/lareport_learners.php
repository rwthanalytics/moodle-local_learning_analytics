...
$string['participated_before'] = 'Anteil';
$string['participating_now'] = 'Anteil';

$string['most_active_learners'] = 'Aktiveste Lerner';
$string['countries_of_learners'] = 'Herkunft der Lerner';
$string['languages_of_learners'] = 'Sprache der Lerner';
